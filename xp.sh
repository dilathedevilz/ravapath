...
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/worryfree.json
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/grpc.json
rm -f /usr/local/etc/xray/$user-tls.json /usr/local/etc/xray/$user-none.json /usr/local/etc/xray/$user-grpc.json /usr/local/etc/xray/$user-worryfree.json  /usr/local/etc/xray/$user-maxis.json /usr/local/etc/xray/$user-maxistv.json /usr/local/etc/xray/$user-celcom.json /usr/local/etc/xray/$user-digi.json /usr/local/etc/xray/$user-yes.json /usr/local/etc/xray/$user-umo.json
